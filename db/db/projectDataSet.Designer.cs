...
namespace db {
    ...
    public partial class projectDataSet : global::System.Data.DataSet {
        ...
        public partial class jobsDataTable : global::System.Data.TypedTableBase<jobsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public jobsRow AddjobsRow(string job) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public jobsRow FindByjob(string job) {
...
namespace db.projectDataSetTableAdapters {
    ...
    public partial class jobsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[jobs] WHERE (([job] = @Original_job))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[jobs] SET [job] = @job WHERE (([job] = @Original_job));\r\nSELECT job" +
                " FROM jobs WHERE (job = @job)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::db.Properties.Settings.Default.projectConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT job FROM dbo.jobs";
        ...
        public virtual int Fill(projectDataSet.jobsDataTable dataTable) {
        ...
        public virtual projectDataSet.jobsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            projectDataSet.jobsDataTable dataTable = new projectDataSet.jobsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(projectDataSet.jobsDataTable dataTable) {
        ...
        public virtual int Update(string job, string Original_job) {
            if ((job == null)) {
            ...
            if ((Original_job == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(Original_job));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Original_job) {
            return this.Update(Original_job, Original_job);
        }
    }
